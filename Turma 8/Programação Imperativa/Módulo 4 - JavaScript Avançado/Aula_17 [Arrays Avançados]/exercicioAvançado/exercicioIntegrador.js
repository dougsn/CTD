...
function lucroTotal(){
    for (let i = 0; i < arrayProdutos.length; i++) {
        let total =  (produto1.preco * produto1.quantidadeVendida) + (produto2.preco * produto2.quantidadeVendida) + (produto3.preco * produto3.quantidadeVendida)
...
console.log(arrayProdutos.sort((a,b) => {
